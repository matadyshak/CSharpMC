    ...
    public class MySqlCrud
    {
        ...
        public void ResetTablesAndAllPrimaryKeys()
        {
            ...
            sql = @"alter table Contacts AUTO_INCREMENT = 1;
                    alter table PhoneNumbers AUTO_INCREMENT = 1;
                    alter table EmailAddresses AUTO_INCREMENT = 1;
                    alter table ContactPhoneNumbers AUTO_INCREMENT = 1;
                    alter table ContactEmail AUTO_INCREMENT = 1;";
            db.SaveData(sql, new { }, _connectionString);
        }
